...
import { Plus, FileText, Users, Package, Calculator, Download, Bike, Wrench } from "lucide-react";
    ...
    <div className="flex flex-wrap items-center gap-2 mb-6">
      ...
      {actions.map((action, index) => (
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          className="inline-flex items-center gap-2 px-3 py-2 bg-card rounded-lg border border-border hover:border-orange-500/30 hover:bg-orange-500/5 transition-all duration-150 group"
        >
          <action.icon size={14} className="text-muted-foreground group-hover:text-orange-500 transition-colors" />
